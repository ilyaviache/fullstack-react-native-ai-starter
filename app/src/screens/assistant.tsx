...
export function Assistant() {
  ...
  async function generateAssistantResponse() {
    try {
      ...
      const { assistantId: _assistantId, threadId: _threadId, runId: _runId } = await response;
  ...
  return (
    <KeyboardAvoidingView behavior="padding" style={styles.container} keyboardVerticalOffset={110}>
      ...
      >
        {!isStarted && (
          <View style={styles.midChatInputWrapper}>
            <View style={styles.midChatInputContainer}>
              ...
              >
                <MaterialCommunityIcons name="file-outline" color={theme.textColor} size={24} />
              </TouchableHighlight>
              <TouchableHighlight onPress={createThread} underlayColor={'transparent'}>
                <View style={styles.midButtonStyle}>
                  <Ionicons name="chatbox-ellipses-outline" size={22} color={theme.tintTextColor} />
        ...
        {Boolean(isStarted) && (
          <FlatList data={openaiResponse} renderItem={renderItem} scrollEnabled={false} />
        )}
        {loading && (
      ...
      {Boolean(isStarted) && (
        <View style={styles.chatInputContainer}>
          ...
          >
            <MaterialCommunityIcons name="file-outline" color={theme.textColor} size={22} />
          </TouchableHighlight>
