          ...
          try {
            ...
            if (event.data !== '[DONE]' || !JSON.parse(event.data).is_finished) {
              ...
              if (JSON.parse(event.data).text) {
                ...
                if (!localResponse && JSON.parse(event.data).text.charAt(0) === ' ') {
      ...
      <View style={styles.promptResponse} key={index}>
        ...
        {item.assistant && (
          <View style={styles.textStyleContainer}>
            <Markdown style={styles.markdownStyle as any}>{item.assistant}</Markdown>
            <TouchableHighlight
            ...
            <View style={styles.midChatInputContainer}>
              ...
              <TouchableHighlight onPress={chat} underlayColor={'transparent'}>
                <View style={styles.midButtonStyle}>
                  ...
                  <Text style={styles.midButtonText}>Start {chatType.name} Chat</Text>
                </View>
              </TouchableHighlight>
      ...
      {callMade && (
        <View style={styles.chatInputContainer}>
          <TextInput
            ...
            value={input}
          />
          <TouchableHighlight underlayColor={'transparent'} activeOpacity={0.65} onPress={chat}>
